...
print (f"{item_7:<40}   \t{price_7:>6.2f}   *\t {quantity_7:.2f}  = {price_1*quantity_7:>6.2f} zł")
print (f"{item_8:<40}   \t{price_8:>6.2f}   *\t {quantity_8:.2f}  = {price_1*quantity_8:>6.2f} zł")
print (f"{item_9:<40}   \t{price_9:>6.2f}   *\t {quantity_9:.2f}  = {price_1*quantity_9:>6.2f} zł")
print (f'='*85)
